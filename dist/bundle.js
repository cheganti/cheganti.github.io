...
/***/ "./src/Components/ApiService/channelsApiService.js":
/*!*********************************************************!*\
  !*** ./src/Components/ApiService/channelsApiService.js ***!
  \*********************************************************/
/*! no static exports found */
...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n  value: true\n});\nexports.ChannelsApiService = void 0;\n\nfunction asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }\n\nfunction _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, \"next\", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, \"throw\", err); } _next(undefined); }); }; }\n\nfunction _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError(\"Cannot call a class as a function\"); } }\n\nfunction _defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if (\"value\" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } }\n\nfunction _createClass(Constructor, protoProps, staticProps) { if (protoProps) _defineProperties(Constructor.prototype, protoProps); if (staticProps) _defineProperties(Constructor, staticProps); return Constructor; }\n\n// Options for the select\nvar ChannelsApiService =\n/*#__PURE__*/\nfunction () {\n  function ChannelsApiService() {\n    _classCallCheck(this, ChannelsApiService);\n\n    this.sourcesAPI = 'https://newsapi.org/v1/sources';\n  } // getNewsChannelCategories() {\n  //     return fetch(this.sourcesAPI).\n  //         then(response => response.json()).\n  //         then(data => data.sources).\n  //         catch(error => console.log(error));\n  // }\n\n\n  _createClass(ChannelsApiService, [{\n    key: \"getNewsChannelCategories\",\n    value: function () {\n      var _getNewsChannelCategories = _asyncToGenerator(\n      /*#__PURE__*/\n      regeneratorRuntime.mark(function _callee() {\n        var response, responseJson, datasources;\n        return regeneratorRuntime.wrap(function _callee$(_context) {\n          while (1) {\n            switch (_context.prev = _context.next) {\n              case 0:\n                _context.next = 2;\n                return fetch(this.sourcesAPI);\n\n              case 2:\n                response = _context.sent;\n                responseJson = response.json();\n                datasources = responseJson.sources;\n                return _context.abrupt(\"return\", datasources);\n\n              case 6:\n              case \"end\":\n                return _context.stop();\n            }\n          }\n        }, _callee, this);\n      }));\n\n      function getNewsChannelCategories() {\n        return _getNewsChannelCategories.apply(this, arguments);\n      }\n\n      return getNewsChannelCategories;\n    }()\n  }]);\n\n  return ChannelsApiService;\n}();\n\nexports.ChannelsApiService = ChannelsApiService;\n\n//# sourceURL=webpack:///./src/Components/ApiService/channelsApiService.js?");

/***/ }),

/***/ "./src/Components/ApiService/newsApiService.js":
/*!*****************************************************!*\
  !*** ./src/Components/ApiService/newsApiService.js ***!
  \*****************************************************/
/*! no static exports found */
...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n  value: true\n});\nexports.getNewsArticles = getNewsArticles;\n\nfunction getNewsArticles(channelCode) {\n  var API_KEY = \"172bf5976fff458cbf68f242df25671f\";\n  var base_url = \"https://newsapi.org/v1/articles?source=\";\n  var url = \"\".concat(base_url).concat(channelCode, \"&apiKey=\").concat(API_KEY);\n  return fetch(url).then(function (resp) {\n    return resp.json();\n  }).then(function (data) {\n    return data.articles;\n  })[\"catch\"](function (error) {\n    alert(\"Somethig went wrong while fetching News\"); // let errorMsg = \"Somethig went wrong\";\n    // const errContainer = document.createElement('h3');\n    // container.appendChild(errContainer);\n    // console.log(JSON.stringify(error));\n  });\n}\n\n//# sourceURL=webpack:///./src/Components/ApiService/newsApiService.js?");

/***/ }),

/***/ "./src/Components/Channels/ChannelsList.js":
/*!*************************************************!*\
  !*** ./src/Components/Channels/ChannelsList.js ***!
  \*************************************************/
/*! no static exports found */
...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n  value: true\n});\nexports.ChannelsList = void 0;\n\nvar _channelsApiService = __webpack_require__(/*! ../ApiService/channelsApiService */ \"./src/Components/ApiService/channelsApiService.js\");\n\nvar _channelsDropdown = __webpack_require__(/*! ./channelsDropdown */ \"./src/Components/Channels/channelsDropdown.js\");\n\nfunction _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError(\"Cannot call a class as a function\"); } }\n\nfunction _defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if (\"value\" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } }\n\nfunction _createClass(Constructor, protoProps, staticProps) { if (protoProps) _defineProperties(Constructor.prototype, protoProps); if (staticProps) _defineProperties(Constructor, staticProps); return Constructor; }\n\nvar ChannelsList =\n/*#__PURE__*/\nfunction () {\n  function ChannelsList() {\n    _classCallCheck(this, ChannelsList);\n  }\n\n  _createClass(ChannelsList, [{\n    key: \"showChannels\",\n    value: function showChannels() {\n      var channelsApiService = new _channelsApiService.ChannelsApiService();\n      var channelsDropdown = new _channelsDropdown.ChannelsDropdown();\n      var channels = channelsApiService.getNewsChannelCategories();\n      console.log(\"channels\", channels);\n      channelsDropdown.bindOptions(channels); // then(channels => {\n      //     console.log(\"channels\", channels);\n      //     channelsDropdown.bindOptions(channels);\n      //     // TODO: Channels List also need to show below the dropdown. For that need to use ChannelTemplate component.\n      // });\n    }\n  }]);\n\n  return ChannelsList;\n}();\n\nexports.ChannelsList = ChannelsList;\n\n//# sourceURL=webpack:///./src/Components/Channels/ChannelsList.js?");

/***/ }),

/***/ "./src/Components/Channels/channelsDropdown.js":
/*!*****************************************************!*\
  !*** ./src/Components/Channels/channelsDropdown.js ***!
  \*****************************************************/
/*! no static exports found */
...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n  value: true\n});\nexports.ChannelsDropdown = void 0;\n\nfunction _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError(\"Cannot call a class as a function\"); } }\n\nfunction _defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if (\"value\" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } }\n\nfunction _createClass(Constructor, protoProps, staticProps) { if (protoProps) _defineProperties(Constructor.prototype, protoProps); if (staticProps) _defineProperties(Constructor, staticProps); return Constructor; }\n\nvar ChannelsDropdown =\n/*#__PURE__*/\nfunction () {\n  function ChannelsDropdown() {\n    _classCallCheck(this, ChannelsDropdown);\n  }\n\n  _createClass(ChannelsDropdown, [{\n    key: \"bindOptions\",\n    value: function bindOptions(channels) {\n      // let options = channels.map(channel => ({ name: channel.name, id: channel.id, cate: channel.category }));\n      var select = document.getElementById(\"apiUrl\");\n      channels.forEach(function (item) {\n        var el = document.createElement(\"option\");\n        el.textContent = item.name;\n        el.value = item.id;\n        select.appendChild(el);\n      });\n    }\n  }]);\n\n  return ChannelsDropdown;\n}();\n\nexports.ChannelsDropdown = ChannelsDropdown;\n\n//# sourceURL=webpack:///./src/Components/Channels/channelsDropdown.js?");

/***/ }),

/***/ "./src/Components/News/newsArticle.js":
/*!********************************************!*\
  !*** ./src/Components/News/newsArticle.js ***!
  \********************************************/
/*! no static exports found */
...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n  value: true\n});\nexports.bindNewsToDOM = bindNewsToDOM;\n\nvar _newsArticle = __webpack_require__(/*! ./newsArticle */ \"./src/Components/News/newsArticle.js\");\n\nfunction bindNewsToDOM(newsArticles) {\n  var spinner = document.querySelector(\".spinner\"); //Spinner to show when fetching api data\n\n  spinner.style.display = 'block'; //Spinner\n\n  document.getElementById('container1').textContent = '';\n  document.getElementById('card-deck').style.display = 'none';\n  var newsArticleCreator = new _newsArticle.NewsArticle();\n\n  if (newsArticles) {\n    newsArticles.map(function (newsArticle) {\n      newsArticleCreator.createDom(newsArticle);\n      spinner.style.display = 'none';\n    });\n  }\n}\n\n//# sourceURL=webpack:///./src/Components/News/newsArticlesList.js?");

/***/ }),

/***/ "./src/Components/handleEvents.js":
/*!****************************************!*\
  !*** ./src/Components/handleEvents.js ***!
  \****************************************/
/*! no static exports found */
...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n  value: true\n});\nexports.handleEvents = handleEvents;\n\nvar _newsApiService = __webpack_require__(/*! ./ApiService/newsApiService */ \"./src/Components/ApiService/newsApiService.js\");\n\nvar _newsArticlesList = __webpack_require__(/*! ./News/newsArticlesList */ \"./src/Components/News/newsArticlesList.js\");\n\n// Handle events on selecting the channels\nfunction handleEvents() {\n  var channelFilter = document.getElementById('apiUrl');\n  var buttonFilter = document.getElementsByClassName('card-title');\n  channelFilter.addEventListener('change', function (e) {\n    if (e.target.tagName === 'SELECT' && e.target.value !== 'Select') {\n      (0, _newsApiService.getNewsArticles)(e.target.value).then(function (newsArticles) {\n        (0, _newsArticlesList.bindNewsToDOM)(newsArticles);\n      });\n    }\n  });\n\n  for (var i = 0; i < buttonFilter.length; i++) {\n    buttonFilter[i].addEventListener('click', function (e) {\n      if (e.target.tagName === 'H4') {\n        (0, _newsApiService.getNewsArticles)(e.target.title).then(function (newsArticles) {\n          (0, _newsArticlesList.bindNewsToDOM)(newsArticles);\n        });\n      }\n    });\n  }\n}\n\n//# sourceURL=webpack:///./src/Components/handleEvents.js?");
...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n  value: true\n});\nexports[\"default\"] = void 0;\n\n__webpack_require__(/*! whatwg-fetch */ \"./node_modules/whatwg-fetch/fetch.js\");\n\n__webpack_require__(/*! @babel/polyfill */ \"./node_modules/@babel/polyfill/lib/index.js\");\n\nvar _handleEvents = __webpack_require__(/*! ./Components/handleEvents */ \"./src/Components/handleEvents.js\");\n\nvar _ChannelsList = __webpack_require__(/*! ./Components/Channels/ChannelsList */ \"./src/Components/Channels/ChannelsList.js\");\n\nfunction _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError(\"Cannot call a class as a function\"); } }\n\nvar NewsArtiles = function NewsArtiles() {\n  _classCallCheck(this, NewsArtiles);\n\n  var app = document.getElementById('root');\n  var container = document.createElement('div');\n  container.setAttribute('class', 'container1');\n  container.setAttribute('id', 'container1');\n  app.appendChild(container);\n  var channelsList = new _ChannelsList.ChannelsList();\n  channelsList.showChannels();\n  (0, _handleEvents.handleEvents)();\n};\n\nvar _default = NewsArtiles;\nexports[\"default\"] = _default;\nnew NewsArtiles();\n\n//# sourceURL=webpack:///./src/main.js?");
